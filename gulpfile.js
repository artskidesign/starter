...
// vendor task
gulp.task('vendor', gulp.parallel(newFunction(), 'vendor:js'));
...
gulp.task('dev', function browserDev(done) {
  ...
  gulp.watch('assets/scss/modules/*.scss', gulp.series('css:minify', function cssBrowserReload (done) {
    browserSync.reload();
    done();
  }));
  gulp.watch('assets/scss/mixins/*.scss', gulp.series('css:minify', function cssBrowserReload (done) {
    browserSync.reload();
    done();
  }));
